...
namespace DotTest.Component.Db {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class StoreDataTable : global::System.Data.TypedTableBase<StoreRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StoreRow AddStoreRow(string FullName, bool Result) {
        ...
        public partial class StoreRow : global::System.Data.DataRow {
            ...
            public string FullName {
                get {
                    try {
                        return ((string)(this[this.tableStore.FullNameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'FullName\' in table \'Store\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStore.FullNameColumn] = value;
                }
            }
            ...
            public bool Result {
                get {
                    try {
                        return ((bool)(this[this.tableStore.ResultColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Result\' in table \'Store\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableStore.ResultColumn] = value;
                }
            }
            ...
            public bool IsFullNameNull() {
                return this.IsNull(this.tableStore.FullNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFullNameNull() {
                this[this.tableStore.FullNameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsResultNull() {
                return this.IsNull(this.tableStore.ResultColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetResultNull() {
                this[this.tableStore.ResultColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DotTest.Component.Db.DataSetTableAdapters {
    ...
    public partial class StoreTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Store] ([FullName], [Result]) VALUES (@FullName, @Result)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Result", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "Result", global::System.Data.DataRowVersion.Current, null));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DotTest.Properties.Settings.Default.StoreDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [FullName], [Result] FROM [Store]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        1 AS Expr1\r\nFROM            Store\r\nWHERE        (FullName = @FullNa" +
                "me)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@FullName", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "FullName", global::System.Data.DataRowVersion.Current, null));
            this._commandCollection[2] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT [FullName] FROM [Store] WHERE  [Result] = 1";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "\tINSERT        \r\n\tINTO [Store]([FullName], [Result])\r\n\tVALUES (@FullName,@Result)" +
                "; \r\n";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@FullName", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "FullName", global::System.Data.DataRowVersion.Current, null));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Result", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "Result", global::System.Data.DataRowVersion.Current, null));
            ...
            this._commandCollection[4].CommandText = "SELECT        COUNT(*) AS Expr1\r\nFROM            Store\r\nWHERE        (FullName = " +
                "@FullName) AND (Result = 1)";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@FullName", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "FullName", global::System.Data.DataRowVersion.Current, null));
            this._commandCollection[5] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "UPDATE       [Store]\r\nSET                 [Result] = @Result\r\nWHERE        [FullN" +
                "ame] = @FullName";
            this._commandCollection[5].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@Result", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "Result", global::System.Data.DataRowVersion.Current, null));
            this._commandCollection[5].Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@FullName", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, true, 0, 0, "FullName", global::System.Data.DataRowVersion.Original, null));
        }
        ...
        public virtual int Fill(DataSet.StoreDataTable dataTable) {
        ...
        public virtual DataSet.StoreDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet.StoreDataTable dataTable = new DataSet.StoreDataTable();
        ...
        public virtual DataSet.StoreDataTable GetSuccessTest() {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet.StoreDataTable dataTable) {
        ...
        public virtual int Insert(string FullName, global::System.Nullable<bool> Result) {
            if ((FullName == null)) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> Existe(string FullName) {
        ...
        public virtual int InsertTestResult(string FullName, global::System.Nullable<bool> Result) {
            ...
            if ((Result.HasValue == true)) {
                command.Parameters[1].Value = ((bool)(Result.Value));
            }
            else {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> SkipCase(string FullName) {
        ...
        public virtual int UpdateTestResult(global::System.Nullable<bool> Result, string FullName) {
            global::System.Data.SqlServerCe.SqlCeCommand command = this.CommandCollection[5];
            if ((Result.HasValue == true)) {
                command.Parameters[0].Value = ((bool)(Result.Value));
            }
            else {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int UpdateAll(DataSet dataSet) {
            ...
            try {
                ...
                if ((this._storeTableAdapter != null)) {
                    ...
                    this._storeTableAdapter.Connection = ((global::System.Data.SqlServerCe.SqlCeConnection)(workConnection));
                    this._storeTableAdapter.Transaction = ((global::System.Data.SqlServerCe.SqlCeTransaction)(workTransaction));
                ...
                if ((this._storeTableAdapter != null)) {
                    this._storeTableAdapter.Connection = ((global::System.Data.SqlServerCe.SqlCeConnection)(revertConnections[this._storeTableAdapter]));
